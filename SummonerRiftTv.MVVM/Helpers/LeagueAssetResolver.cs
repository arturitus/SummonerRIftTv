...
namespace SummonerRiftTv.MVVM.Helpers
{
    public static class LeagueAssetResolver
    {
        ...
        //{
        //    return new Bitmap(AvaloniaLocator.Current.GetService<IAssetLoader>()!.Open(new Uri($"avares://SummonerRiftTv/Assets/SummonerSpells/{id}.png")));
        //}
        ...
        //                }
        //            }
        //            return new Bitmap(AvaloniaLocator.Current.GetService<IAssetLoader>()!.Open(new Uri($"avares://SummonerRiftTv/Assets/Champions/-1.png")));
        //        }
        //    }
        //}
        ...
        //    return new Bitmap(AvaloniaLocator.Current.GetService<IAssetLoader>()!.Open(new Uri($"avares://SummonerRiftTv/Assets/Champions/{id}.png")));
        //}
